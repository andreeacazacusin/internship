...
namespace TestFormsApp {
    ...
    public partial class booksDataSet : global::System.Data.DataSet {
        ...
        public partial class BooksDataTable : global::System.Data.TypedTableBase<BooksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public BooksRow AddBooksRow(string InventoryNumber, string Author, string Title, string Description, string Labels) {
            ...
            private void InitClass() {
                ...
                this.columnLabels.MaxLength = 2147483647;
            }
        ...
        public partial class BooksRow : global::System.Data.DataRow {
            ...
            public string InventoryNumber {
                get {
                    return ((string)(this[this.tableBooks.InventoryNumberColumn]));
                }
                set {
            ...
            public string Labels {
                get {
                    try {
                        return ((string)(this[this.tableBooks.LabelsColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Labels\' in table \'Books\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableBooks.LabelsColumn] = value;
                }
            }
            ...
            public bool IsLabelsNull() {
                return this.IsNull(this.tableBooks.LabelsColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public void SetLabelsNull() {
                this[this.tableBooks.LabelsColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace TestFormsApp.booksDataSetTableAdapters {
    ...
    public partial class BooksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Books] WHERE (([Id] = @Original_Id) AND ([InventoryNumber] = @" +
                "Original_InventoryNumber) AND ([Author] = @Original_Author) AND ([Title] = @Orig" +
                "inal_Title))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Books] ([InventoryNumber], [Author], [Title], [Description], [Labels]) VALUES (@InventoryNumber, @Author, @Title, @Description, @Labels);
SELECT Id, InventoryNumber, Author, Title, Description, Labels FROM Books WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Books] SET [InventoryNumber] = @InventoryNumber, [Author] = @Author, [Title] = @Title, [Description] = @Description, [Labels] = @Labels WHERE (([Id] = @Original_Id) AND ([InventoryNumber] = @Original_InventoryNumber) AND ([Author] = @Original_Author) AND ([Title] = @Original_Title));
SELECT Id, InventoryNumber, Author, Title, Description, Labels FROM Books WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::TestFormsApp.Properties.Settings.Default.libraryConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, InventoryNumber, Author, Title, Description, Labels FROM dbo.Books";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT Id, InventoryNumber, Author, Title, Description, Labels FROM dbo.Books";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT Id, InventoryNumber, Author, Title, Description, Labels FROM dbo.Books";
        ...
        public virtual int FillBy(booksDataSet.BooksDataTable dataTable) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillBy1(booksDataSet.BooksDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_InventoryNumber, string Original_Author, string Original_Title) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_Id));
            if ((Original_InventoryNumber == null)) {
                throw new global::System.ArgumentNullException("Original_InventoryNumber");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[1].Value = ((string)(Original_InventoryNumber));
            }
        ...
        public virtual int Insert(string InventoryNumber, string Author, string Title, string Description, string Labels) {
            ...
            if ((Labels == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[4].Value = ((string)(Labels));
            }
        ...
        public virtual int Update(string InventoryNumber, string Author, string Title, string Description, string Labels, int Original_Id, string Original_InventoryNumber, string Original_Author, string Original_Title, int Id) {
            if ((InventoryNumber == null)) {
                throw new global::System.ArgumentNullException("InventoryNumber");
            }
            else {
            ...
            if ((Labels == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[4].Value = ((string)(Labels));
            }
            ...
            if ((Original_InventoryNumber == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(Original_InventoryNumber));
            }
            if ((Original_Author == null)) {
                throw new global::System.ArgumentNullException("Original_Author");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string InventoryNumber, string Author, string Title, string Description, string Labels, int Original_Id, string Original_InventoryNumber, string Original_Author, string Original_Title) {
            return this.Update(InventoryNumber, Author, Title, Description, Labels, Original_Id, Original_InventoryNumber, Original_Author, Original_Title, Original_Id);
        }
    }
